                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-6 offset-md-3">
                        <form action="{{ url('stock/'.$stock->id).'/prosespakai' }}" method="post">
                          @method('PUT')
                          @csrf
                          ...
                          <div class="form-group">
                            <label>stock pakai</label>
                            <input name="pakai" type="number" class="form-control @error('pakai') is-invalid @enderror" value="{{ old('stock') }}">
                            @error('pakai')
                              <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                          </div>
                          <div class="form-group">
                            ...
                            <input name="supplier" type="hidden" class="form-control @error('supplier') is-invalid @enderror" value="{{ $stock->supplier }}" readonly>
                            @error('supplier')
                              <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                          </div>
                          <div class="form-group">
                            {{-- <label>harga</label> --}}
                            <input name="harga" type="hidden" class="form-control @error('harga') is-invalid @enderror" value="{{ $stock->harga }}" readonly>
                            @error('harga')
                              <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                          </div>
